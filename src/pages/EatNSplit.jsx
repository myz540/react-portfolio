...
function Friend({ friend, onSelectFriend, selectedFriend }) {
  ...
  return (
    <li className={isSelected ? styles.selected : ""}>
      ...
      <button className={styles.button} onClick={() => onSelectFriend(friend)}>
...
function FriendForm({ onAddFriend }) {
  ...
  return (
    <form className={styles.formAddFriend} onSubmit={handleSubmission}>
...
function SplitBillForm({ friend, onSplitBill }) {
  ...
  return (
    <form className={styles.formSplitBill} onSubmit={handleSubmission}>
      ...
      <button className={styles.button}>Split Bill</button>
    </form>
  );
}
